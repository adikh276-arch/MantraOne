...
import { Activity, Database, Clock, LayoutTemplate, Network, History } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-300 font-mono p-8">
      <header className="mb-8 border-b border-neutral-800 pb-4">
        ...
        <p className="text-sm mt-2 opacity-60">Developer tool for visualizing exact retrieval mechanisms.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
           <section className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 h-[500px] flex flex-col">
              ...
              <div className="flex-1 border border-neutral-800 rounded-lg bg-black/50 flex items-center justify-center relative overflow-hidden">
                 <p className="text-neutral-500 text-sm animate-pulse">Waiting for graph data...</p>
                 ...
                 <table className="w-full text-sm text-left">
                    ...
                    <tbody>
                       <tr className="border-b border-neutral-800">
                          <td className="px-4 py-3">"What changed in Dad's health?"</td>
        ...
        <div className="space-y-8">
           <section className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
              <h2 className="text-lg font-bold text-white flex items-center gap-2 mb-4">
                 <LayoutTemplate className="w-5 h-5 text-orange-500" /> Context Package
              </h2>

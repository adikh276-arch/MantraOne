...
pdf.multi_cell(
    0,
    10,
    txt="Patient reports worsening insomnia over the past 3 weeks, sleeping only 4 hours per night. Occasional mild chest tightness under stress. Blood pressure elevated at 145/90.",
)
pdf.ln(5)

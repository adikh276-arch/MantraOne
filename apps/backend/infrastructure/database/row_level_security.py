...
RLS_TABLES = [
    "family_members", "health_baselines", "daily_checkins", "watcher_signals",
    "coordinator_decisions", "health_metrics", "medications", "medication_logs",
    "documents", "diagnoses", "consultations", "escalation_events",
]
